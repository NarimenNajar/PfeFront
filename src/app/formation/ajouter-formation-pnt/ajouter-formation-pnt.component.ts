...
@Component({
  selector: 'app-ajouter-formation-pnt',
  templateUrl: './ajouter-formation-pnt.component.html',
  styleUrls: ['./ajouter-formation-pnt.component.css']
})
export class AjouterFormationPNTComponent implements OnInit {
  ...
  async Creer() {
    await this.formationService.ajouterFormationPNTAsync(this.activiteFormation).then( e => this.router.navigateByUrl('/training/allPNT') );
  }
