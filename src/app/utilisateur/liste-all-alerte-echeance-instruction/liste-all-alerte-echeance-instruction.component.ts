...
@Component({
  selector: 'app-liste-all-alerte-echeance-instruction',
  templateUrl: './liste-all-alerte-echeance-instruction.component.html',
  styleUrls: ['./liste-all-alerte-echeance-instruction.component.css']
})
export class ListeAllAlerteEcheanceInstructionComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.listeUtilisateursService.afficherAllAlerteEcheanceInstructions().subscribe(data => {
