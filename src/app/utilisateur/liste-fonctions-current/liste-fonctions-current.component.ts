...
@Component({
  selector: 'app-liste-fonctions-current',
  templateUrl: './liste-fonctions-current.component.html',
  styleUrls: ['./liste-fonctions-current.component.css']
})
export class ListeFonctionsCurrentComponent implements OnInit {
