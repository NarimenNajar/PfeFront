...
@Component({
  selector: 'app-liste-my-instructions-today-trainee',
  templateUrl: './liste-my-instructions-today-trainee.component.html',
  styleUrls: ['./liste-my-instructions-today-trainee.component.css']
})
export class ListeMyInstructionsTodayTraineeComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.listeUtilisateursService.afficherMyAlerteInstructionsTodayTrainee(this.idUtilisateur).subscribe(data => {
