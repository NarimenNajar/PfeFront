...
@Component({
  selector: 'app-liste-my-alerte-echeance-instruction',
  templateUrl: './liste-my-alerte-echeance-instruction.component.html',
  styleUrls: ['./liste-my-alerte-echeance-instruction.component.css']
})
export class ListeMyAlerteEcheanceInstructionComponent implements OnInit {
  ...
  async ngOnInit() {
   ...
   // console.log(this.activatedRoute.snapshot.paramMap.get('id'));
    this.listeUtilisateursService.afficherMyAlerteEcheanceInstructions(this.userConnected.id).subscribe(data => {
