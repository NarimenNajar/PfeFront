...
@Component({
  selector: 'app-liste-my-instructions-today-instructor',
  templateUrl: './liste-my-instructions-today-instructor.component.html',
  styleUrls: ['./liste-my-instructions-today-instructor.component.css']
})
export class ListeMyInstructionsTodayInstructorComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.listeUtilisateursService.afficherMyAlerteInstructionsTodayInstructor(this.idUtilisateur).subscribe(data => {
